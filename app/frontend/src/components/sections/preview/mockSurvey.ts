...
export const mockSurvey: SurveyPreview = {
  ...
  description: "Un exemple complet montrant tous les types de questions disponibles. Utilisez ce template comme inspiration pour créer vos propres enquêtes professionnelles.",
  public: true,
