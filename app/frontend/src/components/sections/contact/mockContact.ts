...
export const faq = [
    {
        ...
        answer:
            "Vous pouvez utiliser le formulaire de contact, nous écrire par email ou nous appeler directement. Nous sommes à votre écoute !",
    },
    {
        question: "Quels sont vos horaires d'ouverture ?",
        answer:
            "Nous sommes disponibles du lundi au vendredi de 9h à 18h, et le samedi de 10h à 16h.",
    },
    {
        question: "Où sont situés vos bureaux ?",
        answer:
            "Nous sommes situés au 1 Place de l'Hopital, 69002 Lyon, France.",
    },
    {
        question: "Proposez-vous un support technique ?",
        answer:
            "Oui, notre équipe technique est disponible pour répondre à toutes vos questions et résoudre vos problèmes.",
    },
    {
        question: "Puis-je réserver une consultation gratuite ?",
        answer:
            "Bien sûr ! Réservez un créneau via notre page de contact ou contactez-nous directement.",
    },
] as const
