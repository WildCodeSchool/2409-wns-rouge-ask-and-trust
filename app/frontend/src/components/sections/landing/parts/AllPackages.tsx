...
const AllPackages = () => {
	return (
		<div className="flex flex-col gap-22 lg:flex-row lg:gap-20">
			...
			<Link
				to="/payment"
				className="shadow-component rounded-xl shadow-black/10 duration-200 hover:scale-[1.05]"
			>
			...
			<Link
				to="/payment"
				className="shadow-component scale-[1.3] rounded-xl shadow-black/10 duration-200 hover:scale-[1.35]"
			>
				<div className="secondary bg-primary-default max-w-[271px] rounded-t-xl py-3 text-center text-white">
