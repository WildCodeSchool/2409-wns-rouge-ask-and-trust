...
/**
 * StripeContextProvider Component
 * @description
 * A provider component that makes the Stripe context available to all child components.
 * It manages the state for payment operations and provides methods to update that state.
 */
