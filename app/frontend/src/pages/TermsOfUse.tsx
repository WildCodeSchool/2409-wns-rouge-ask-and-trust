...
function TermsOfUse() {
	return (
		<section className="bg-bg container mx-auto max-w-4xl px-4 py-20 max-md:pb-[calc(var(--footer-height)+80px)]">
			<h1
			...
			<div className="prose prose-lg max-w-none">
				...
				>
					<p className="mb-4">
						Avant toute utilisation du site Internet et des services
						proposés par la Wild Code School (marque enregistrée par
						la société INNOV'EDUC), vous devez lire attentivement
						les présentes Conditions Générales d'Utilisation et de
						Services, car elles contiennent d'importantes
						informations et stipulations, relatives à vos
						obligations, droits et recours.
					</p>
					<p className="mb-4">
						Les présentes Conditions Générales d'Utilisation et de
						Services (ci-après les "Conditions Générales") des sites
						wildcodeschool.com et odyssey.wildcodeschool.com
						(ci-après le "Site ") sont éditées par la société
						INNOV'EDUC (ci-après la "Société"), société par actions
						simplifiées au capital social de 14 250 €, dont le siège
						social est situé au 44 rue Alphonse Penaud, 75020 Paris
						(RCS Chartres 794 926 063), société éditrice du site
						wildcodeschool.com, dont le numéro de TVA
						intracommunautaire est FR 27 794 926 063. Organisme de
				...
				>
					...
					<p className="mb-4">
						...
						dans l'économie numérique, dite L.C.E.N., nous portons à
						la connaissance des utilisateurs et visiteurs du site
				...
				>
					...
					<p>
						...
						support électronique quel qu'il soit est formellement
						interdite sauf autorisation expresse du directeur de la
						publication.
					</p>
				</article>
				...
				>
					...
					<p className="mb-4">
						Les informations recueillies via nos formulaires sont
						enregistrées dans un fichier informatisé par [Nom de
						votre entreprise] pour [finalité du traitement].
					</p>
					<p className="mb-4">
						Conformément au Règlement Général sur la Protection des
						Données (RGPD), vous pouvez exercer votre droit d'accès
						aux données vous concernant et les faire rectifier en
						contactant : [contact pour les données personnelles].
					</p>
					<p>
				...
				>
					...
					<p className="mb-4">
						Notre site internet utilise des cookies pour améliorer
						l'expérience utilisateur et analyser le trafic du site.
						Vous pouvez accepter ou refuser ces cookies à tout
						moment en modifiant les paramètres de votre navigateur.
					</p>
					<p>
				...
				>
					...
					<p className="mb-4">
						...
						matériel de l'utilisateur, lors de l'accès au site, et
						résultant soit de l'utilisation d'un matériel ne
						répondant pas aux spécifications techniques requises,
						soit de l'apparition d'un bug ou d'une incompatibilité.
					</p>
					<p>
						[Nom de votre entreprise] ne pourra également être tenue
						responsable des dommages indirects consécutifs à
				...
				<article title="Droit applicable et coordonnées de contact">
					...
					<p className="mb-4">
						...
						français. En cas de litige, les tribunaux français
						seront compétents.
					</p>
					<p className="mb-4">
						Pour toute question relative aux mentions légales de
						notre site, vous pouvez nous contacter par email à
						contact@wildcodeschool.fr ou par courrier au Innov'Educ,
						à l'attention de service Protection des Données, 18 rue
						de la Gare, 28240, La Loupe.
					</p>
					<p className="mb-4">
