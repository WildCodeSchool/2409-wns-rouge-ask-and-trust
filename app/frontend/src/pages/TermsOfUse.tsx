					...
					<div className="prose prose-lg max-w-none">
						...
						>
							<p className="mb-4">
								...
								services proposés par la Wild Code School
								(marque enregistrée par la société INNOV'EDUC),
								vous devez lire attentivement les présentes
						...
						>
							...
							<p className="mb-4">
								...
								et 19 de la Loi n° 2004-575 du 21 juin 2004 pour
								la Confiance dans l'économie numérique, dite
								L.C.E.N., nous portons à la connaissance des
								utilisateurs et visiteurs du site les
						...
						>
							...
							<p className="mb-4">
								...
								française et internationale sur le droit
								d'auteur et la propriété intellectuelle. Tous
								les droits de reproduction sont réservés, y
								compris pour les documents téléchargeables et
								les représentations iconographiques et
								photographiques.
							</p>
							<p>
								La reproduction de tout ou partie de ce site sur
								un support électronique quel qu'il soit est
						...
						>
							...
							<p className="mb-4">
								...
								sont enregistrées dans un fichier informatisé
								par [Nom de votre entreprise] pour [finalité du
								traitement].
							</p>
							<p className="mb-4">
								Conformément au Règlement Général sur la
								Protection des Données (RGPD), vous pouvez
								exercer votre droit d'accès aux données vous
							...
							<p>
								...
								conservation] à compter de [point de départ de
								la conservation].
							</p>
						</article>
						...
						>
							...
							<p className="mb-4">
								...
								améliorer l'expérience utilisateur et analyser
								le trafic du site. Vous pouvez accepter ou
								refuser ces cookies à tout moment en modifiant
								les paramètres de votre navigateur.
							</p>
							<p>
								Pour plus d'informations sur notre utilisation
								des cookies, veuillez consulter notre politique
								de confidentialité.
							</p>
						</article>
						...
						>
							...
							<p className="mb-4">
								...
								causés au matériel de l'utilisateur, lors de
							...
							<p>
								[Nom de votre entreprise] ne pourra également
						...
						>
							...
							<p className="mb-4">
								Pour toute question relative aux mentions
								légales de notre site, vous pouvez nous
								contacter par email à contact@wildcodeschool.fr
								ou par courrier au Innov'Educ, à l'attention de
								service Protection des Données, 18 rue de la
								Gare, 28240, La Loupe.
							</p>
							<p className="mb-4">
								Nous vous remercions de votre confiance et de
