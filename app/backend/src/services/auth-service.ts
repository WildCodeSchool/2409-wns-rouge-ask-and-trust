...
export const register = async (email: string, password: string, cookies: Cookies): Promise<User> => {
...
export const login = async (email: string, password: string, cookies: Cookies): Promise<string> => {
    const userRepository = dataSource.getRepository(User);
