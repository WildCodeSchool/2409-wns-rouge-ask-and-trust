 ...
 * @category Entities
 * @description
 * This module defines the `SurveyQuestionAnswered` entity for the database.
 ...
 *
 * @param name is the entity's name in the database (`surveyQuestionAnswered`).
 *
 ...
 * @example
 * ```ts
 * const submission = new SurveyQuestionAnswered()
 ...
 */
@ObjectType()
@Entity({ name: "surveyQuestionAnswered" })
export class SurveyQuestionAnswered extends BaseEntity {
	/**
